...
<center>
    <table border="0" cellspacing="0" cellpadding="9">
        <tr align="center">
            <td  style="padding-right: 20px;">REPORTE POR PERSONA SEGUN FECHA DE REGISTRO</td>
            <td  style="padding-right: 20px;">REPORTE POR INSTITUCION SEGUN FECHA DE REGISTRO</td>
        </tr>
        <tr align="center">
            <td>
