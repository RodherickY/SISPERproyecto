    ...
    <h4>
      ...
      <li>
        <a href="objetivo1.php">
          <span class="material-symbols-outlined"> notes </span>Objetivo 1</a>
      </li>
      <li>
        <a href="objetivo2.php">
          <span class="material-symbols-outlined"> notes </span>Objetivo 2</a>
      </li>
      <li>
        <a href="objetivo3.php">
          <span class="material-symbols-outlined"> notes </span>Objetivo 3</a>
      </li>
      <li>
        <a href="objetivo4.php">
          <span class="material-symbols-outlined"> notes </span>Objetivo 4</a>
      </li>
      <li>
        <a href="objetivo5.php">
          <span class="material-symbols-outlined"> notes </span>Objetivo 5</a>
      </li>
      <li>
        <a href="objetivo6.php">
          <span class="material-symbols-outlined"> notes </span>Objetivo 6</a>
      </li>
